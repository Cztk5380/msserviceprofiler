...
from modelevalstate.sitecustomize import dispatch, MODEL_EVAL_STATE_SIMULATE, MODEL_EVAL_STATE_ALL


class TestDispatch(unittest.TestCase):
    
    @patch('modelevalstate.sitecustomize.logger')
    @patch('modelevalstate.patch.enable_patch')
