...
from ms_service_profiler.msguard.security import update_env_s
from ms_service_profiler.msguard.security import open_s
from ms_service_profiler.msguard.security.hijack import update_env_s as hijack_update_env_s
from ms_service_profiler.msguard.constraints import PathConstraint, Rule, InvalidParameterError
...
class TestUpdateEnvS(unittest.TestCase):
    ...
    def test_update_env_s_with_different_constraint_rules(self):
        ...
        def _process(constraint, test_path, test_var):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            for constraint in constraints_to_test:
                _process(constraint, test_path, test_var)

    @patch('ms_service_profiler.msguard.security.hijack.os.path.abspath')
