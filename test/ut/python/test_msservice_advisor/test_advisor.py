...
from msservice_advisor import advisor
from msservice_advisor.profiling_analyze.utils import TARGETS, SUGGESTION_TYPES, logger
from msservice_advisor.profiling_analyze import utils
...
# Test analyze
@patch("msservice_advisor.profiling_analyze.register.REGISTRY", {"test_analyzer": MagicMock()})
@patch(
    "msservice_advisor.profiling_analyze.register.ANSWERS",
