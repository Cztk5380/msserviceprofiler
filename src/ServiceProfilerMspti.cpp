...
namespace msServiceProfiler {
    ...
    public:
        ...
        void insertApiData(msptiActivityApi* activity)
        {
            ...
            // 绑定参数
            sqlite3_bind_text(stmtApi, 1, activity->name, -1, SQLITE_STATIC);
            sqlite3_bind_int64(stmtApi, 2, static_cast<int64_t>(activity->start));
            sqlite3_bind_int64(stmtApi, 3, static_cast<int64_t>(activity->end));
            sqlite3_bind_int64(stmtApi, 4, activity->pt.processId);
            sqlite3_bind_int64(stmtApi, 5, activity->pt.threadId);
            sqlite3_bind_int64(stmtApi, 6, static_cast<int64_t>(activity->correlationId));
        ...
        void insertKernelData(msptiActivityKernel* activity)
        {
            ...
            // 绑定参数
            sqlite3_bind_text(stmtKernel, 1, activity->type, -1, SQLITE_STATIC);
            sqlite3_bind_text(stmtKernel, 2, activity->name, -1, SQLITE_STATIC);
            sqlite3_bind_int64(stmtKernel, 3, static_cast<int64_t>(activity->start));
            sqlite3_bind_int64(stmtKernel, 4, static_cast<int64_t>(activity->end));
            sqlite3_bind_int64(stmtKernel, 5, activity->ds.deviceId);
            sqlite3_bind_int64(stmtKernel, 6, activity->ds.streamId);
            sqlite3_bind_int64(stmtKernel, 7, static_cast<int64_t>(activity->correlationId));
        ...
        void insertHcclData(msptiActivityHccl* activity)
        {
            ...
            // 绑定参数
            sqlite3_bind_text(stmtHccl, 1, activity->name, -1, SQLITE_STATIC);
            sqlite3_bind_int64(stmtHccl, 2, static_cast<int64_t>(activity->start));
            sqlite3_bind_int64(stmtHccl, 3, static_cast<int64_t>(activity->end));
            sqlite3_bind_int64(stmtHccl, 4, static_cast<int64_t>(activity->ds.deviceId));
            sqlite3_bind_int64(stmtHccl, 5, static_cast<int64_t>(activity->ds.streamId));
            sqlite3_bind_int64(stmtHccl, 6, static_cast<int64_t>(activity->bandWidth));
            sqlite3_bind_text(stmtHccl, 7, activity->commName, -1, SQLITE_STATIC);
