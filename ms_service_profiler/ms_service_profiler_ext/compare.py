...
from ms_service_profiler.msguard.security import mkdir_s, open_s
...
def process_file_pairs(file_pairs, db_conn, excel_writer):
    ...
    from ms_service_profiler.ms_service_profiler_ext.compare_tools import CSVComparator, DBComparator
...
def main(args):
    ...
    from ms_service_profiler.ms_service_profiler_ext.compare_tools.collector import FileCollector
