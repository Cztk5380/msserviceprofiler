...
2. 完成 SGLang 在NPU上的安装和部署，确保可以正常运行推理服务，具体请参见 [SGLang installation with NPUs support](https://docs.sglang.io/platforms/ascend_npu.html)。
3. 请参见《[msServiceProfiler工具安装指南 - 升级](./msserviceprofiler_install_guide.md#升级)》章节，基于源码构建 run 包并完成升级。
