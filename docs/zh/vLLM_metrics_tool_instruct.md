...
- **功能限制**：部分高级功能需要特定版本的 vLLM-ascend 框架支持；**不支持在推理过程中动态开关 metrics**。
...
export METRIC_SYMBOLS_PATH=$PWD/ms_service_profiler/patcher/vllm/config/service_metrics_symbols.yaml
