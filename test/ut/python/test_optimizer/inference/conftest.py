...
def static_file():
    ...
    with tempfile.TemporaryDirectory() as base_dir:
        ...
        with open(sf.hardware_path, "w", encoding="utf-8") as hf:
            data = {"cpu_count": 256, "cpu_mem": 2063351, "soc_name": "xxxx", "npu_mem": 62259}
            json.dump(data, hf)
        with open(sf.env_path, "w", encoding="utf-8") as ef:
            data = {
            ...
            json.dump(data, ef)
        with open(sf.mindie_config_path, "w", encoding="utf-8") as mf:
            data = {
            ...
            json.dump(data, mf)
        with open(sf.config_path, "w", encoding="utf-8") as f:
            data = {
                ...
                "quantization_config": {"group_size": 0, "kv_quant_type": None, "reduce_quant_type": None},
            }
            json.dump(data, f)
        with open(sf.model_struct_path, "w", encoding="utf-8") as f:
            f.write(
...
52,1923244800,0.4818347659122749,0.003282452655013028,4.4724415737403786e-05,"""
        ...
        with open(sf.model_decode_op_path, "w", encoding="utf-8") as f:
            f.write(
            ...
            f.write("\n")
            f.write(
                """1,5,RmsNormOperation,6,5,float16;float16;float16;float16;int8,"1,7168;7168;7168;1;1",1,"""
...
1,5,ActivationOperation,3,1,float16,"1,2304",1,float16,"1,1152",10.787474747474748,12.65040404040404,"""
        ...
        with open(sf.model_prefill_op_path, "w", encoding="utf-8") as f:
            f.write(
                "batch_size,max_seq_len,op_name,call_count,input_count,input_dtype,input_shape,output_count,"
                "output_dtype,output_shape,host_setup_time,host_execute_time,kernel_execute_time,"
                "aic_cube_fops,aiv_vector_fops"
            ...
            f.write("\n")
            f.write(
                """1,4,SplitOperation,6,1,float16,"6144,576",2,float16;float16,"6144,512;6144,64","""
