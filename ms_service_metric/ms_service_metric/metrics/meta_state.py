...
class MetaState:
    ...
    def set(self, key: str, value: Any):
        ...
        if old_value != value:
            logger.debug("MetaState updated: %s = %s (was %s)", key, value, old_value)
    ...
    def update(self, data: Dict[str, Any]):
        ...
        logger.debug("MetaState batch updated: %s", list(data.keys()))
    ...
    def remove(self, key: str) -> bool:
        ...
        with self._lock:
            if key in self._data:
                del self._data[key]
                logger.debug("MetaState removed: %s", key)
                return True
            return False
...
def get_phase() -> str:
    """Get current execution phase label."""
    return get_meta_state().get("phase", "mixed")


def set_phase(phase: str):
    """Set current execution phase label."""
    get_meta_state().set("phase", phase)
